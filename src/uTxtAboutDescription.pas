...
const
  CTxtEN = '''
Swap Keys Generator is a simple generator of reversible bytes lists or arrays in different programming languages for swapping from a byte value to an other.
...
''';
   CTxtFR = '''
Swap Keys Generator est un simple générateur de listes d'octets réversibles ou de tableaux dans différents langages de programmation pour passer d'une valeur d'octet à une autre.
