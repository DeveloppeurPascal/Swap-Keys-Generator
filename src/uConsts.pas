...
const
  ...
  /// </summary>
  CAboutURL = 'https://swapkeysgenerator.olfsoftware.fr/';

  /// <summary>
  /// The URL where you can buy the software.
  /// (if not empty, a "Buy" button is added in the About Box)
  /// </summary>
  CSoftwareBuyURL = 'https://store.olfsoftware.fr/en/developer-software-c-3/swap-keys-generator-p-27';
  ...
  CSupportURL =
    ...
    // TODO : à basculer sur el site du logiciel lorsqu'il sera disponible
  ...
  /// </remarks>
  CProjectFolderName = 'SwapKeysGenerator';
